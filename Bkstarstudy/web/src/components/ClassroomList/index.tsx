...
//         const classesData: any = await getMethod('/classrooms')
...
export default function ClassroomList() {
    ...
    const onMounted = async () => {
        ...
        if (classesData && Array.isArray(classesData)) {
            ...
            // Optionally set classrooms to an empty array or handle the error as needed
            setClassrooms([]);
        }
    };
        ...
        <Box sx={{ mt: 4 }}>
            <Grid container spacing={2} >
                {classrooms.map((classroom) => (
                    ...
                    {/*<Grid key={classroom.id} item xs={12} sm={6} md={4} lg={3}>*/}
